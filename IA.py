...
ActivationHiddensLayers = ActivationReLU()
...
for epoch in range(51):
    ...
    layer1.forward(X)
    ActivationHiddensLayers.forward(layer1.output)
    output.forward(layer1.output)

    loss = ActivationOut.forward(output.output, y_true)
    ...
    ActivationOut.backward(ActivationOut.output, y_true)
    output.backward(ActivationOut.dinputs)
    ActivationHiddensLayers.backward(output.dinputs)
    layer1.backward(ActivationHiddensLayers.dinputs)
...
loss = ActivationOut.forward(output.output, y_true2)
...
# print("Weights layer 1 : ", layer1.weights)
# print("\nWeights Output : ", output.weights)

# print("\n\nBiases layer 1 : ", layer1.weights)
# print("\nBiases Output : ", output.weights)